function showPremiumWindow ()
	...
	if getElementData ( lp, "premium" ) then
		if gWindow["tuningPremium"] then
			...
			false )
			gLabel["tuningLightColor"] = guiCreateLabel(59,24,60,16,"Licht",false,gWindow["tuningPremium"])
...
function SubmitLeaveTuningBtn (btn)
	...
	if btn == "left" then
		...
		triggerServerEvent ( "CancelTuning", lp, lp, veh, c1, c2, c3, c11, c12, c13, c21, c22, c23, c31, c32, c33, curpainting, t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16 )
	end
end
...
function SubmitColorLeft ()
	curfarbe = tonumber ( guiGetText(gLabel["FarbeMiddle"]) )
	if curfarbe == 1 then curfarbe = 4 else
		curfarbe = curfarbe - 1
	end
	guiSetText ( gLabel["FarbeMiddle"], curfarbe )
	local veh = getPedOccupiedVehicle ( lp )
end

function SubmitColorRight ()
	curfarbe = tonumber ( guiGetText(gLabel["FarbeMiddle"]) )
	if curfarbe == 4 then curfarbe = 1 else
		curfarbe = curfarbe + 1
	end
	guiSetText ( gLabel["FarbeMiddle"], curfarbe )
	local veh = getPedOccupiedVehicle ( lp )
...
function SubmitpaintLeft2 ()
	...
	curcolor2 = tonumber ( guiGetText(gLabel["PaintingMiddle2"]) )
	if curcolor2 == 0 then curcolor2 = 255 else
		curcolor2 = curcolor2 - 1
	end
	guiSetText ( gLabel["PaintingMiddle2"], curcolor2 )
	local veh = getPedOccupiedVehicle ( lp )
	local c1, c2, c3, c11, c12, c13, c21, c22, c23, c31, c32, c33 = getVehicleColor ( veh )
if curpainting == 1 then
	setVehicleColor ( veh, curcolor2, c2, c3, c11, c12, c13, c21, c22, c23, c31, c32, c33 )
elseif curpainting == 2 then
	setVehicleColor ( veh, c1, c2, c3, curcolor2, c12, c13, c21, c22, c23, c31, c32, c33 )
elseif curpainting == 3 then
	setVehicleColor ( veh, c1, c2, c3, c11, c12, c13, curcolor2, c22, c23, c31, c32, c33 )
elseif curpainting == 4 then
	setVehicleColor ( veh, c1, c2, c3, c11, c12, c13, c21, c22, c23, curcolor2, c32, c33 )
end
end
function SubmitpaintRight2 ()

	curcolor2 = tonumber ( guiGetText(gLabel["PaintingMiddle2"]) )
	if curcolor2 == 255 then curcolor2 = 0 else
		curcolor2 = curcolor2 + 1
	end
	guiSetText ( gLabel["PaintingMiddle2"], curcolor2 )
	local veh = getPedOccupiedVehicle ( lp )
...
function SubmitpaintLeft3 ()
	...
	curcolor3 = tonumber ( guiGetText(gLabel["PaintingMiddle3"]) )
	if curcolor3 == 0 then curcolor3 = 255 else
		curcolor3 = curcolor3 - 1
	end
	guiSetText ( gLabel["PaintingMiddle3"], curcolor3 )
	local veh = getPedOccupiedVehicle ( lp )
	local c1, c2, c3, c11, c12, c13, c21, c22, c23, c31, c32, c33 = getVehicleColor ( veh )
if curpainting == 1 then
	setVehicleColor ( veh, c1, curcolor3, c3, c11, c12, c13, c21, c22, c23, c31, c32, c33 )
elseif curpainting == 2 then
	setVehicleColor ( veh, c1, c2, c3, c11, curcolor3, c13, c21, c22, c23, c31, c32, c33 )
elseif curpainting == 3 then
	setVehicleColor ( veh, c1, c2, c3, c11, c12, c13, c21, curcolor3, c23, c31, c32, c33 )
elseif curpainting == 4 then
	setVehicleColor ( veh, c1, c2, c3, c11, c12, c13, c21, c22, c23, c31, curcolor3, c33 )
end
end
function SubmitpaintRight3 ()

	curcolor3 = tonumber ( guiGetText(gLabel["PaintingMiddle3"]) )
	if curcolor3 == 255 then curcolor3 = 0 else
		curcolor3 = curcolor3 + 1
	end
	guiSetText ( gLabel["PaintingMiddle3"], curcolor3 )
	local veh = getPedOccupiedVehicle ( lp )
...
function SubmitpaintLeft4 ()
	...
	curcolor4 = tonumber ( guiGetText(gLabel["PaintingMiddle4"]) )
	if curcolor4 == 0 then curcolor4 = 255 else
		curcolor4 = curcolor4 - 1
	end
	guiSetText ( gLabel["PaintingMiddle4"], curcolor4 )
	local veh = getPedOccupiedVehicle ( lp )
	local c1, c2, c3, c11, c12, c13, c21, c22, c23, c31, c32, c33 = getVehicleColor ( veh )
if curpainting == 1 then
	setVehicleColor ( veh, c1, c2, curcolor4, c11, c12, c13, c21, c22, c23, c31, c32, c33 )
elseif curpainting == 2 then
	setVehicleColor ( veh, c1, c2, c3, c11, c12, curcolor4, c21, c22, c23, c31, c32, c33 )
elseif curpainting == 3 then
	setVehicleColor ( veh, c1, c2, c3, c11, c12, c13, c21, c22, curcolor4, c31, c32, c33 )
elseif curpainting == 4 then
	setVehicleColor ( veh, c1, c2, c3, c11, c12, c13, c21, c22, c23, c31, c32, curcolor4 )
end
end
function SubmitpaintRight4 ()

	curcolor4 = tonumber ( guiGetText(gLabel["PaintingMiddle4"]) )
	if curcolor4 == 255 then curcolor4 = 0 else
		curcolor4 = curcolor4 + 1
	end
	guiSetText ( gLabel["PaintingMiddle4"], curcolor4 )
	local veh = getPedOccupiedVehicle ( lp )
			...
			if data2 <= getElementData ( lp, "money" ) then
				if mounted == "    [_]" then
					...
					if getElementData ( player, "sprache" ) == "Deutsch" then
						infobox_start ( "\n\nDieses Teil hast du bereits!", 7500, 125, 0, 0 )
					else
						infobox_start ( "\n\nThis part you have got already!", 7500, 125, 0, 0 )
					end
				end
			else
				if getElementData ( player, "sprache" ) == "Deutsch" then
					...
					infobox_start ( "\n\nYou haven't got enough money!", 7500, 125, 0, 0 )
				end
			end
		else
...
function createTuningMenue ()
	...
	if gWindow["tuningMenue"] then
		...
		gLabel["Lack"] = guiCreateLabel(0.8054,0.5164,0.1527,0.0428,"Lack:",true,gWindow["tuningMenue"])
		...
		gButton["paintLeft"] = guiCreateButton(0.8054,0.56+0.1,0.05,0.05,"<",true,gWindow["tuningMenue"])
		guiSetAlpha(gButton["paintLeft"],1)
		gLabel["PaintingMiddle"] = guiCreateLabel(0.86,0.56+0.1,0.1527,0.0428,"0",true,gWindow["tuningMenue"])
		guiSetAlpha(gLabel["PaintingMiddle"],1)
		guiLabelSetColor(gLabel["PaintingMiddle"],125,0,0)
		guiLabelSetVerticalAlign(gLabel["PaintingMiddle"],"top")
		guiLabelSetHorizontalAlign(gLabel["PaintingMiddle"],"left",false)
		gButton["paintRight"] = guiCreateButton(0.9,0.56+0.1,0.05,0.05,">",true,gWindow["tuningMenue"])
		...
		gLabel["Farbe"] = guiCreateLabel(0.8054,0.5164+0.1,0.1527,0.0428,"Farbe:",true,gWindow["tuningMenue"])
		...
		gButton["colorLeft"] = guiCreateButton(0.8054,0.56,0.05,0.05,"<",true,gWindow["tuningMenue"])
		guiSetAlpha(gButton["colorLeft"],1)
		gLabel["FarbeMiddle"] = guiCreateLabel(0.86,0.56,0.1527,0.0428,"1",true,gWindow["tuningMenue"])
		guiSetAlpha(gLabel["FarbeMiddle"],1)
		guiLabelSetColor(gLabel["FarbeMiddle"],125,125,0)
		guiLabelSetVerticalAlign(gLabel["FarbeMiddle"],"top")
		guiLabelSetHorizontalAlign(gLabel["FarbeMiddle"],"left",false)
		gButton["colorRight"] = guiCreateButton(0.9,0.56,0.05,0.05,">",true,gWindow["tuningMenue"])
		guiSetAlpha(gButton["colorRight"],1)
		...
		gButton["delUpgrade"] = guiCreateButton(0.8177,0.3123,0.1527,0.0806,"Löschen",true,gWindow["tuningMenue"])
	...
	local c1, c2, c3, c11, c12, c13, c21, c22, c23, c31, c32, c33 = getVehicleColor ( veh )
	guiSetText ( gLabel["FarbeMiddle"], 1 )
	guiSetText ( gLabel["PaintingMiddle2"], c1 )
	guiSetText ( gLabel["PaintingMiddle3"], c2 )
	guiSetText ( gLabel["PaintingMiddle4"], c3 )
	guiGridListClear ( gGrid["tuningSelect"] )
