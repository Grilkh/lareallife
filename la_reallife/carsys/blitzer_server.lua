				...
				if (getVehicleType ( hitElement )== "Automobile") or (getVehicleType ( hitElement )== "Bike") or (getVehicleType ( hitElement )== "Quad") or (getVehicleType ( hitElement )== "Monster Truck") then
					...
					if getVehicleSirensOn ( hitElement ) or isArmy(currentdriver) or isOnDuty(currentdriver) then
						...
						if (currentspeed >= 120 ) then
							...
							local oldstvo = laGetElementData( currentdriver, "stvo_punkte" )
							...
							laSetElementData( currentdriver, "stvo_punkte", newstvo)
							outputChatBox("Du wurdest geblitzt! Du musst "..strafgeld.."$ Strafe zahlen und hast "..stvonumber.." STVO Punkt(e) erhalten, da du "..roundgeschw.."km/h zu schnell gefahren bist!", currentdriver,255,0,0)
							...
							laSetElementData ( currentdriver, "money", laGetElementData ( currentdriver, "money" ) - strafgeld )
						end
					end
				end
			end
