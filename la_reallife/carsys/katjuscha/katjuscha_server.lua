...
function createKatjuscha ( x, y, z, rx, ry, rz )
	...
	laSetElementData ( _G["katjuschaNo"..katjCount], "katjuscha", true )
	laSetElementData ( _G["katjuschaNo"..katjCount], "fireAble", true )
	laSetElementData ( _G["katjuschaNo"..katjCount], "katjuschaID", katjCount )
...
function fireKatjuscha ( id, x, y, z )
	...
	if player and isTerror ( player ) then
		if laGetElementData ( katjuscha, "fireAble" ) then
...
function katjuscha_func ( p )
	...
	if isTerror ( p ) and laGetElementData ( p, "rang" ) >= 4 then
