		...
		if valid then
			if Besitzer == MySQL_Save ( Besitzer ) then
				if isOwnerActive ( Besitzer ) then
					...
					if not badMySQLCarHouseXSpawns[Spawnpos_X] then
						...
						if Spawnpos_X ~= -1935.8837890625 and Spawnpos_X ~= -1928.6640625 then
							...
							laSetElementData ( veh, "stuning", STuning )
							setVehicleAsMagnetHelicopter ( veh )
							setVehicleRotation ( veh, Spawnrot_X, Spawnrot_Y, Spawnrot_Z )
							laSetElementData ( veh, "owner", Besitzer )
							laSetElementData ( veh, "name", veh )
							laSetElementData ( veh, "carslotnr_owner", Slot )
							laSetElementData ( veh, "locked", true )
							laSetElementData ( veh, "color", Farbe )
							laSetElementData ( veh, "spawnpos_x", Spawnpos_X )
							laSetElementData ( veh, "spawnpos_y", Spawnpos_Y )
							laSetElementData ( veh, "spawnpos_z", Spawnpos_Z )
							laSetElementData ( veh, "spawnrot_x", Spawnrot_X )
							laSetElementData ( veh, "spawnrot_y", Spawnrot_Y )
							laSetElementData ( veh, "spawnrot_z", Spawnrot_Z )
							laSetElementData ( veh, "special", Special )
							laSetElementData ( veh, "lcolor", carsData["Lights"] )
							laSetElementData ( veh, "distance", tonumber ( carsData["Distance"] ) )
							setPrivVehCorrectLightColor ( veh )
							setVehicleLocked ( veh, true )
							laSetElementData ( veh, "fuelstate", tonumber ( Benzin ) )
