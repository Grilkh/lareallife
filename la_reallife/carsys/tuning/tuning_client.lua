function showPremiumWindow ()
	...
	if getElementData ( lp, "premium" ) then
		if gWindow["tuningPremium"] then
			...
			gButton["submitLightColor"] = guiCreateButton(48,162,91,38,"Übernehmen / Save",false,gWindow["tuningPremium"])
			...
			false )
			gLabel["tuningLightColor"] = guiCreateLabel(59,24,60,16,"Licht / Light",false,gWindow["tuningPremium"])
...
function createTuningMenue ()
	...
	if gWindow["tuningMenue"] then
		...
		gLabel["Geld"] = guiCreateLabel(0.8177,0.0982,0.1281,0.0479,"Geld / Money:",true,gWindow["tuningMenue"])
		...
		gLabel["Farbe"] = guiCreateLabel(0.8054,0.5164,0.1527,0.0428,"Lack / Paint:",true,gWindow["tuningMenue"])
		...
		gLabel["Lack"] = guiCreateLabel(0.8054,0.5164+0.1,0.1527,0.0428,"Farbe / Color:",true,gWindow["tuningMenue"])
		...
		gButton["buyUpgrade"] = guiCreateButton(0.8177,0.2141,0.1527,0.0806,"Kaufen / Buy",true,gWindow["tuningMenue"])
		guiSetAlpha(gButton["buyUpgrade"],1)
		gButton["delUpgrade"] = guiCreateButton(0.8177,0.3123,0.1527,0.0806,"Löschen / Delete",true,gWindow["tuningMenue"])
		...
		false )
		gButton["closeUpgradeStore"] = guiCreateButton(0.8177,0.4081,0.1527,0.0806,"Schliessen / Close",true,gWindow["tuningMenue"])
