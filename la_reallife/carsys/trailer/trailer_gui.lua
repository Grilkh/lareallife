trailerMarker = createMarker ( -911.3271484375, -486.00863647461, 24.89, "cylinder", 3, 0, 0, 255, 150 )
	...
	if hit == lp and dim then
		if not getPedOccupiedVehicle ( lp ) then
			...
			if gWindow["wohnwagen"] then
				...
				gLabel[3] = guiCreateLabel(13,114,63,15,"150.000$",false,gWindow["wohnwagen"])
				...
				gRadio["trailerPayEC"] = guiCreateRadioButton(9,157,68,14,"Bankkonto",false,gWindow["wohnwagen"])
