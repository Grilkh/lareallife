...
function createNewSweeperRubbish ()
	...
	if not oldX or ( oldX ~= x1 ) then
		rubbishPickup = createMarker ( x1, y1, z1, "checkpoint", 5, 255, 255, 255, 150 )
