...
local function aktion(player)
	...
	and brand == 1 then
		...
		outputDebugString("feuerwehr_server: 52 - PED erstellt hurt1")
		hurt2 = createPed(126, -2058.5, -584.40002441406, 30.299999237061, 14.803833007813)
		outputDebugString("feuerwehr_server: 54 - PED erstellt hurt2")
		outputDebugString("biz: 91 - PED erstellt bizped")
