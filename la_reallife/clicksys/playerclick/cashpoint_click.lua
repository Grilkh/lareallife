	...
	if gWindow["cashPoint"] then
		...
		gTabPanel["cashPoint"] = guiCreateTabPanel(9,24,334,287,false,gWindow["cashPoint"])
			...
			gTab["cashPointTransfer"] = guiCreateTab("Überweisung",gTabPanel["cashPoint"])
				...
				gLabel[3] = guiCreateLabel(102,1,127,14,"Überweisungsformular",false,gImage["cashPointTransferBGHead"])
				...
				gLabel[4] = guiCreateLabel(2,32,150,20,"Name des Begünstigten",false,gImage["cashPointTransferBG"])
			...
			gTab["cashPointPrint"] = guiCreateTab("Kontoauszug",gTabPanel["cashPoint"])
				...
				gLabel[19] = guiCreateLabel(135,234,54,12,"Blättern",false,gTab["cashPointPrint"])
