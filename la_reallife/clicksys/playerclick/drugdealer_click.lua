function showDrugMenue ()
	...
	if gWindow["drogenverkauf"] then
		...
		gWindow["drogenverkauf"] = guiCreateWindow(screenwidth/2-255/2, 145,255,119,"Weedverkauf",false)
		guiSetAlpha(gWindow["drogenverkauf"],1)
		gLabel["drogen"] = guiCreateLabel(14,30,109,18,"Weed (in gramm)",false,gWindow["drogenverkauf"])
