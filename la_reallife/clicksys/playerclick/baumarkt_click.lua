local x, y, z = -2590.076, 59.798, 3.435
createMarker ( x, y, z, "cylinder", 3, 0, 0, 255, 150 )
baumarktSphere = createColSphere ( x, y, z, 3 )
createBlip ( x, y, z, 57, 2, 255, 0, 0, 255, 0, 200 )
