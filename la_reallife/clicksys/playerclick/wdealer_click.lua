function wDealerWindow()
	...
	if gWindow["waffendealer"] then
		...
		gWindow["waffendealer"] = guiCreateWindow(screenwidth/2-365/2,145,365,399,"Waffen Menü",false)
		...
		gRadio["9mmsd"] = guiCreateRadioButton(26,63,100,15,"9mm Schallgedämpft",false,gWindow["waffendealer"])
