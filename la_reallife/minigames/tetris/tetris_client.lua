	...
	if getElementData ( lp, "gameboy" ) == 1 then
		if isElement ( gImage["Back"] ) then
			...
			if diff then
				...
				outputChatBox ( "Tippe /stop blocks, um das Spiel zu beenden.", 125, 0, 0 )
...
function stoptetris_func ( cmd, arg )
...
addCommandHandler ( "stop", stoptetris_func )
...
function createTetrisField ( parent )
	...
	gImage["Left"] = guiCreateStaticImage ( 0, 0, leftSizeX * stretch, settings.SizeY, "images/tetris/left.bmp", false, gImage["Back"] )
	gImage["Center"] = guiCreateStaticImage ( leftSizeX * stretch, 0, settings.SizeX, settings.SizeY, "images/tetris/white.bmp", false, gImage["Back"] )
	gImage["Right"] = guiCreateStaticImage ( settings.SizeX + leftSizeX * stretch, 0, rightSizeX * stretch, settings.SizeY, "images/tetris/right.bmp", false, gImage["Back"] )
	...
	gImage["showbox"] = guiCreateStaticImage ( 0.39, 0.73, (settings.boxsize*4)/(rightSizeX * stretch), (settings.boxsize*4)/settings.SizeY, "images/tetris/white.bmp", true, gImage["Right"] )
