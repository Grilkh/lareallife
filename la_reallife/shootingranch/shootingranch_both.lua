...
shootingRangeGunIDs = {}
 ...
 i = i + 1
 --shootingRangeGuns["name"][i], shootingRangeGuns["id"][i] = "9mm Gedämpft", 23
 --i = i + 1
 ...
 --shootingRangeGuns["name"][i], shootingRangeGuns["id"][i] = "Lupara", 26
  i = i + 1
 shootingRangeGuns["name"][i], shootingRangeGuns["id"][i] = "Uzi", 28
 i = i + 1
 ...
 --i = i + 1
 --shootingRangeGuns["name"][i], shootingRangeGuns["id"][i] = "Sniper", 34
