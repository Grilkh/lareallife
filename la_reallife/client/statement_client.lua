...
function getStatementFile ()
	...
	local file = xmlLoadFile ( ":"..resourceName.."/money/money.xml" )
	if not file then
		file = xmlCreateFile ( ":"..resourceName.."/money/money.xml", "Account" )
		xmlSaveFile ( file )
		file = xmlLoadFile ( ":"..resourceName.."/money/money.xml" )
