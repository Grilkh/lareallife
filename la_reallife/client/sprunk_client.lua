...
sprunkAutomats = {}
 ...
 i = i + 1
 sprunkAutomats["x"][i], sprunkAutomats["y"][i], sprunkAutomats["z"][i] = -2169.1000976563, 262.70001220703, 35.400001525879
 i = i + 1
 sprunkAutomats["x"][i], sprunkAutomats["y"][i], sprunkAutomats["z"][i] = -1401.5, -311.60000610352, 6.0999999046326
...
createObject ( 1775, -2169.1000976563, 262.70001220703, 35.400001525879, 0, 0, 0 )
createObject ( 1775, -1401.5, -311.60000610352, 6.0999999046326, 0, 0, 302 )
