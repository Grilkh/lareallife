...
function showCamorraGunshop_func()

	guiSetVisible ( WaffenauswahlFenster, true )
	showCursor ( true )
	setElementData ( lp, "ElementClicked", true )
end
addEvent ( "showCamorraGunshop", true)
addEventHandler ( "showCamorraGunshop", getRootElement(), showCamorraGunshop_func)

function SubmitCamorraGunshopAbbrechenBtn (btn)
...
addEvent ( "SubmitCamorraGunshopAbbrechen", true)
addEventHandler ( "SubmitCamorraGunshopAbbrechen", getRootElement(), SubmitCamorraGunshopAbbrechenBtn)

function SubmitCamorraGunshopBaseballBtn ( btn )
...
function SubmitCamorraGunshopSchaufelBtn ( btn )
...
function SubmitCamorraGunshopMesserBtn ( btn )
...
function SubmitCamorraGunshopSchlagringBtn ( btn )
...
function SubmitCamorraGunshop9mmBtn ( btn )
...
function SubmitCamorraGunshop9mmSDBtn ( btn )
...
function SubmitCamorraGunshopDeagleBtn ( btn )
...
function SubmitCamorraGunshopMp5Btn ( btn )
...
function SubmitCamorraGunshopShotgunBtn ( btn )
...
function SubmitCamorraGunshopAk47Btn ( btn )
...
function SubmitCamorraGunshopM4Btn ( btn )
...
function SubmitCamorraGunshopGewehrBtn ( btn )
...
function SubmitCamorraGunshopSGewehrBtn ( btn )
...
function SubmitCamorraGunshopRaketenwerferBtn ( btn )
...
function SubmitCamorraGunshopLuparaBtn ( btn )
...
function SubmitCamorraGunshopArmorBtn ( btn )
...
function SubmitCamorraGunshop9mmAmmoBtn ( btn )
...
function SubmitCamorraGunshopEagleAmmoBtn ( btn )
...
function SubmitCamorraGunshopMp5AmmoBtn ( btn )
...
function SubmitCamorraGunshopSchrotBtn ( btn )
...
function SubmitCamorraGunshopAk47AmmoBtn ( btn )
...
function SubmitCamorraGunshopM4AmmoBtn ( btn )
...
function SubmitCamorraGunshopGewehrAmmoBtn ( btn )
...
function SubmitCamorraGunshopSGewehrAmmoBtn ( btn )
...
function SubmitCamorraGunshopRaketeBtn ( btn )
...
function _CreateCamorraGunshop ()
	...
	gButton["baseball"] = guiCreateButton(0.0282,0.1582,0.3229,0.0457,"Baseballschläger",true,WaffenauswahlFenster)
	...
	--gButton["9mmSD"] = guiCreateButton(0.2038,0.2724,0.3417,0.0457,"9mm Schallgedämpft",true,WaffenauswahlFenster)
	...
	addEventHandler("onClientGUIClick", gButton["mgunshopcancel"], SubmitCamorraGunshopAbbrechenBtn, false)
	addEventHandler("onClientGUIClick", gButton["baseball"], SubmitCamorraGunshopBaseballBtn, false)
	addEventHandler("onClientGUIClick", gButton["shovel"], SubmitCamorraGunshopSchaufelBtn, false)
	addEventHandler("onClientGUIClick", gButton["knife"], SubmitCamorraGunshopMesserBtn, false)
	addEventHandler("onClientGUIClick", gButton["schlagring"], SubmitCamorraGunshopSchlagringBtn, false)
	addEventHandler("onClientGUIClick", gButton["9mm"], SubmitCamorraGunshop9mmBtn, false)
	--addEventHandler("onClientGUIClick", gButton["9mmSD"], SubmitCamorraGunshop9mmSDBtn, false)
	addEventHandler("onClientGUIClick", gButton["deagle"], SubmitCamorraGunshopDeagleBtn, false)
	addEventHandler("onClientGUIClick", gButton["mp5"], SubmitCamorraGunshopMp5Btn, false)
	addEventHandler("onClientGUIClick", gButton["shotgun"], SubmitCamorraGunshopShotgunBtn, false)
	addEventHandler("onClientGUIClick", gButton["ak-47"], SubmitCamorraGunshopAk47Btn, false)
	--addEventHandler("onClientGUIClick", gButton["m4"], SubmitCamorraGunshopM4Btn, false)
	addEventHandler("onClientGUIClick", gButton["gewehr"], SubmitCamorraGunshopGewehrBtn, false)
	addEventHandler("onClientGUIClick", gButton["sgewehr"], SubmitCamorraGunshopSGewehrBtn, false)
	addEventHandler("onClientGUIClick", gButton["raketenwerfer"], SubmitCamorraGunshopRaketenwerferBtn, false)
	addEventHandler("onClientGUIClick", gButton["lupara"], SubmitCamorraGunshopLuparaBtn, false)
	addEventHandler("onClientGUIClick", gButton["armor"], SubmitCamorraGunshopArmorBtn, false)
	addEventHandler("onClientGUIClick", gButton["9mmammo"], SubmitCamorraGunshop9mmAmmoBtn, false)
	addEventHandler("onClientGUIClick", gButton["eagleammo"], SubmitCamorraGunshopEagleAmmoBtn, false)
	addEventHandler("onClientGUIClick", gButton["mp5ammo"], SubmitCamorraGunshopMp5AmmoBtn, false)
	addEventHandler("onClientGUIClick", gButton["schrot"], SubmitCamorraGunshopSchrotBtn, false)
	addEventHandler("onClientGUIClick", gButton["ak-47ammo"], SubmitCamorraGunshopAk47AmmoBtn, false)
	addEventHandler("onClientGUIClick", gButton["m4ammo"], SubmitCamorraGunshopM4AmmoBtn, false)
	addEventHandler("onClientGUIClick", gButton["gewehrammo"], SubmitCamorraGunshopGewehrAmmoBtn, false)
	addEventHandler("onClientGUIClick", gButton["sgewehrammo"], SubmitCamorraGunshopSGewehrAmmoBtn, false)
	addEventHandler("onClientGUIClick", gButton["rakete"], SubmitCamorraGunshopRaketeBtn, false)
