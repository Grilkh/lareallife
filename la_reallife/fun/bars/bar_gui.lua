barMarkers = {}
 ...
 barMarkers["size"] = {}
  ...
  -- Los Santos --
  barMarkers["x"][7], barMarkers["y"][7], barMarkers["z"][7], barMarkers["int"][7], barMarkers["dim"][7], barMarkers["size"][7] = 1449.1977539063, -2937.8146972656, 2.0037623023987, 0, 0, 1
...
for key, index in pairs ( barMarkers["x"] ) do
	...
	local marker = createMarker ( x, y, z, "cylinder", size, 0, 0, 255, 150 )
...
function showBarInterface ()
	...
	if gWindow["bar"] then
		...
		gColumn["barGetraenk"] = guiGridListAddColumn(gGrid["barDrinks"],"Getränk",0.6)
		...
		gLabel[1] = guiCreateLabel(149,27,93,19,"Was darf's sein?",false,gWindow["bar"])
