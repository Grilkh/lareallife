...
function dialog6 ()
	...
	setPedAnimation ( TheTruth )
	setPedAnimation ( getLocalPlayer(), "ped", "IDLE_chat", -1, true, true, true )
	DialogText = "Und was haben sie für ein Interesse an ihm?"
...
function dialog7 ()
	...
	setPedAnimation ( getLocalPlayer() )
	setPedAnimation ( TheTruth, "ped", "IDLE_chat", -1, true, false, true )
	DialogText = "Drücken wir es so aus: Die Leute, die ihn haben, sollten nichts von\nmeiner Verbindung zu ihm erfahren. Folgen sie mir, ich stelle die Ausrüstung."
end
...
function briefingStep10 ()
	...
	fadeCamera ( true, 1 )
	r, g, b = 255, 255, 255
	DialogText = "Dring in das Gebäude ein und berge die Beweise -\naber pass auf die Wachen auf, sie werden sofort das Feuer eröffnen."
