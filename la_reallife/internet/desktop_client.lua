...
function showFruitDesktop_func ()
	...
	if gImage["desktopBG"] then
		...
		guiLabelSetColor(gLabel["desktopEmail"],0,0,0)
		...
		guiLabelSetColor(gLabel["desktopAbmelden"],0,0,0)
		...
		guiLabelSetColor(gLabel["desktopOnlineBanking"],0,0,0)
		...
		guiLabelSetColor(gLabel["desktopWebbrowser"],0,0,0)
		...
		gLabel["desktopInfo"] = guiCreateLabel(37,253,441,17,"Angemeldet als: "..pname.." ( "..pname.."@LA-RL.com )",false,gImage["desktopBG"])
		...
		guiLabelSetColor(gLabel["desktopAmmunation"],0,0,0)
