...
function wang_func ()
	...
	gLabel["wang2"] = guiCreateLabel(11,46,380,239,"Erleben Sie die Vielfalt von WangCars bei uns in Los Angeles. Unser \nAngebot umfasst eine grosse Anzahl an Fahrzeugen in allen \nKategorien. Bei uns erwartet Sie ein direkter und höflicher Umgang \nmit Kunden und ein erstklassiger Service direkt vor Ort.\nSie werden schnell merken, dass Ihr Auto bei uns in besten \nHänden liegt. Für genauere Daten\nbesuchen Sie das Forum unter www.la-rl.com",false,img)
	...
	guiSetFont(gLabel["wang1"],"default-bold-small")
	gMemo["wang1"] = guiCreateMemo(7,166,375,34,"www.la-rl.de",false,img)
