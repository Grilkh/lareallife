...
function bank_func ()
	...
	gLabel["Bank6"] = guiCreateLabel(25,219,362,14,"Bei einer Onlineüberweisung entsteht eine Bearbeitungsgebühr",false,img)
	...
	gLabel["Bank7"] = guiCreateLabel(92,233,227,16,"von 10$ pro Überweisung.",false,img)
