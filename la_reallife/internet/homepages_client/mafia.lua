...
gMemo["Mafia1"] = guiCreateMemo(19,98,361,164,"Herzlich Wilkommen auf der Homepage der Mafia.\nDie Aufgaben eines Mafiosis, sind hauptsächlich organisierte Verbrechen, wie z.B. Schutzgelderpressungen oder Geiselnahmen. Die Mafia ist aber auch im Drogen- und Waffenhandel aktiv. Unsere Don-Villa und somit unser Hauptsitz befindet sich Nordöstlich von San-Fierro.\n\nFür weitere Informationen, schreiben sie uns eine Mail oder\nbesuchen sie uns im Forum. Dort könne sie sich auch\nbewerben. Wir brauchen immer neue Mafiosi !",false,img)
...
addEvent ( "mafia.la", true )
addEventHandler ( "mafia.la", getRootElement(), mafia_func )