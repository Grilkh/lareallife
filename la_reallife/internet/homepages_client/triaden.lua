...
gLabel["Triaden2"] = guiCreateLabel(114,62,183,13,"Wir sind die Macht in Los Angeles !",false,img)
...
gMemo["Triaden1"] = guiCreateMemo(5,102,390,167,"Herzlich Wilkommen auf der Homepage der Triaden, die stärkste Fraktion auf LA! Wir haben unseren Hauptsitz in Chinatown, SF.\nUnsere Hauptaufgabe besteht aus Geiselnahmen und organisierte\nVerbrechen wie z.b. Raubüberfälle.\nNebensächlich kümmern wir uns natürlich auch im kleinere Ver-\nbrechen wie z.B. Drogenhandel.\nAls Spezialwaffen besitzen wir Katanas.\n\nInteresse bekommen?\nWir suchen ständig neue Mitglieder ! Einfach im Forum bewerben!",false,img)
guiMemoSetReadOnly(gMemo["Triaden1"],true)
addEventHandler("onClientGUIClick", gButton["Triaden1"], showtriaden_mail, false)
end
addEvent ( "triaden.la", true )
addEventHandler ( "triaden.la", getRootElement(), triaden_func )