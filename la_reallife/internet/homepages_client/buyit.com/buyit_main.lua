...
addEventHandler ( maindomane, getRootElement(), 
	function  ()
		...
		gLabel[2] = guiCreateLabel(32,86,151,16,"Bitte wähle eine Sektion:",false,img)
		...
		gButton[5] = guiCreateButton(208,162,89,41,"Häuser",false,img)
...
function refreshMarketValues_func ( curDrugOffers, curMatsOffers, curVehOffers, curHousesOffers, curPrestigeOffers, curGaragesOffers, curSpecialOffers )
	...
	buyItLink ( gButton[2], "Nicht möglich" )
			...
			if state == "up" then
				...
				if sell then
					if string == "Nicht moeglich" then
						outputChatBox ( "Hier können nur Administratoren etwas verkaufen!", 125, 0, 0 )
					else
