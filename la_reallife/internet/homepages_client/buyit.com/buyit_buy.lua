...
addEventHandler ( maindomane, getRootElement(), 
	function  ()
		...
		gMemo[1] = guiCreateMemo(201,169,110,114,"Bitte wähle eine Auktion aus!",false,img)
		guiMemoSetReadOnly ( gMemo[1], true )
		gLabel[2] = guiCreateLabel(16,89,216,31,"Auktion läuft noch:\n-",false,img)
		...
		gLabel[5] = guiCreateLabel(236,82,142,17,"Aktuelles Höchstgebot:",false,img)
				...
				if state == "up" then
					...
					if row then
						...
						if gebot then
							...
							outputChatBox ( "Du hast ein ungültiges Gebot eintragen!", 125, 0, 0 )
						end
					end
				end
			end,
