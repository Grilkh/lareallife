...
gMemo["FBI1"] = guiCreateMemo(49,79,297,176,"Herzlich Willokmmen auf der Seite der \nFederal Bureau of Investigation.\nUnsere Hauptaufgaben bestehen darin, Waffentrucks abzufangen und Geiselnahmen zu verhindern. Natürlich jagen wir auch mittel-gefährliche Kriminelle.\nDurch unsere Spezialausrüstung koennen wir viele Sachen machen, wie z.b. Kriminelle abhören.\n\nSie wollen den FBI beitreten? \nBewerben sie sich jetzt im Forum!",false,img)
...
addEvent ( "fbi.la", true )
addEventHandler ( "fbi.la", getRootElement(), fbi_func )