...
gMemo["SFPD1"] = guiCreateMemo(15,79,330,140,"Wir, das SFPD kümmern uns um kleinere Verbrechen und führen allgemeine Strassenkontrollen durch.\nWir eilen ausserdem dem FBI und der Army zur Hilfe, wenn sie Hilfe benötigen. Auerdem gehort das Abschleppen von falsch geparkten Autos zu dem Aufgabenfeld des SFPDs.\n\nInteresse bekommen? Jetzt im Forum bewerben !",false,img)
...
addEvent ( "sfpd.la", true )
addEventHandler ( "sfpd.la", getRootElement(), sfpd_func )