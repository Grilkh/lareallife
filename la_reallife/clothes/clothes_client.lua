...
function _createSkinauswahlGui_func ()
	...
	if SkinauswahlWindow then
		...
		gButton["clothesMaennerskins"] = guiCreateButton(0.7,0.075,0.2578,0.0977,"Männerskins",true,SkinauswahlWindow)
		...
		gButton["clothesGuenstig"] = guiCreateButton(0.7,0.3295,0.2682,0.0977,"Günstig",true,SkinauswahlWindow)
